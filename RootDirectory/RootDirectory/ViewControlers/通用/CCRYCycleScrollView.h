...
@protocol CCRYCycleScrollViewDelegate;

@interface CCRYCycleScrollView : UIScrollView<UIScrollViewDelegate>
...
@property (nonatomic, weak) id<CCRYCycleScrollViewDelegate> cycleDelegate;
#endif
...
@protocol CCRYCycleScrollViewDelegate <UIScrollViewDelegate>
